...
/// <summary>
/// Outbound real-time channel contract (Domain, pure — no SignalR dependency).
///
...
///
/// Keeping this as a Domain interface lets the Application layer depend on Domain
/// rather than on the Api layer's SignalR types (preserving dependency direction),
/// and lets unit tests substitute a fake broadcaster.
/// </summary>
